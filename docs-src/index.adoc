...
badge]]
https://depshield.github.io[image:https://depshield.sonatype.org/badges/cchacin/MicroGen/depshield.svg[DepShield
Badge]]
https://maven-badges.herokuapp.com/maven-central/io.microgen/MicroGen[image:https://maven-badges.herokuapp.com/maven-central/io.microgen/MicroGen/badge.svg[Maven
Central]]
endif::[]
