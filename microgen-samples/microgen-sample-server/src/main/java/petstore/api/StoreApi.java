...
public interface StoreApi {
     ...
     */
    @javax.ws.rs.DELETE @javax.ws.rs.Path("store/order/{orderId}")
    ...
    public class DeleteOrderParam {
        @javax.ws.rs.PathParam("orderId") @javax.validation.constraints.Min(1) public Long orderId;
     ...
     * @return {@code java.util.concurrent.CompletionStage<javax.ws.rs.core.Response>}
     */
    @javax.ws.rs.GET @javax.ws.rs.Path("store/inventory")
     ...
     * @return {@code java.util.concurrent.CompletionStage<javax.ws.rs.core.Response>}
     */
    @javax.ws.rs.GET @javax.ws.rs.Path("store/order/{orderId}")
    ...
    public class GetOrderByIdParam {
        @javax.ws.rs.PathParam("orderId") @javax.validation.constraints.Min(1)
        @javax.validation.constraints.Max(10) public Long orderId;
     ...
     * @return {@code java.util.concurrent.CompletionStage<javax.ws.rs.core.Response>}
     */
    @javax.ws.rs.POST @javax.ws.rs.Path("store/order") @javax.ws.rs.Consumes({"application/json"})
    @javax.ws.rs.Produces({"application/xml", "application/json"})
